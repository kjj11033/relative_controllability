function [pvec, pstruct] = tapas_controllability_lrbias2_transp(r, ptrans)
% --------------------------------------------------------------------------------------------------
...
pvec(2*l+4)       = tapas_sgm(ptrans(2*l+4),1); %exp(-ptrans(2*l+4).^2);                  % sa_0
pstruct.alpha_self_rew = pvec(2*l+4);
% pvec(2*l+5)       = tapas_sgm(ptrans(2*l+5),1); %exp(-ptrans(2*l+4).^2);                  % sa_0
% pstruct.alpha_self_pun = pvec(2*l+5);
% tapas_logit
