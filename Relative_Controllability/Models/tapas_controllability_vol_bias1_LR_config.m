function c = tapas_controllability_vol_bias1_LR_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'tapas_controllability_vol_bias1_LR';
...
c.prc_fun = @tapas_controllability_vol_bias1_LR;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @tapas_controllability_vol_bias1_LR_transp;
