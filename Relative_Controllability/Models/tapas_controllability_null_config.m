function c = tapas_controllability_null_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'tapas_controllability_null';
...
c.alpha_self_other_mu = [-1, NaN];
c.alpha_self_other_sa = [2, NaN];
...
c.prc_fun = @tapas_controllability_null;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @tapas_controllability_null_transp;
