function c = tapas_controllability_vol_self_only_LR_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'tapas_controllability_vol_self_only_LR';
...
c.prc_fun = @tapas_controllability_vol_self_only_LR;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @tapas_controllability_vol_self_only_transp;
