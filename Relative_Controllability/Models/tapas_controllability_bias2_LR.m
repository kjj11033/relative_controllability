function [traj, infStates] = tapas_controllability_bias2_LR(r, p, varargin)
...
if ~isempty(varargin) && strcmp(varargin{1},'trans');
    p = tapas_controllability_bias2_LR_transp(r, p);
end
...
%         mu(k,:) = muhat(k,:) + [alpha_self alpha_other].*tapas_sgm([ctr_muhat(k) 1-ctr_muhat(k)],1).*rew_PE(k,:);
        mu(k,:) = muhat(k,:) + [alpha_self*ctr_muhat(k,1) alpha_other*(1-ctr_muhat(k))].*rew_PE(k,:); %*(1-ctr_muhat(k))
