function c = tapas_controllability_lrbias2_config
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Model name
c.model = 'tapas_controllability_lrbias2';
...
% Theta_reward
% c.alpha_self_rew_mu = -1;
% c.alpha_self_rew_sa = 3;
c.alpha_self_pun_mu = -1;
c.alpha_self_pun_sa = 2;
...
c.prc_fun = @tapas_controllability_lrbias2;

% Handle to function that transforms perceptual parameters to their native space
% from the space they are estimated in
c.transp_prc_fun = @tapas_controllability_lrbias2_transp;
