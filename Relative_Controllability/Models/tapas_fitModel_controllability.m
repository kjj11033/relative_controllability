function r = tapas_fitModel_controllability(responses, inputs, varargin)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% ~~~~~~~~~~~~~~~~~~~~~~~~
r.c_prc = tapas_controllability_null_config;

% Default observation model
% ~~~~~~~~~~~~~~~~~~~~~~~~~
r.c_obs = tapas_softmax_binary_controllability_null_config;
...
% Store responses and inputs - input: Task-generated feedback, Response:
% 1-participant's, 2-other's, 3-controllability choice, 4-controllability
% index
